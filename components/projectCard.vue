<template>
  <div class="flex relative items-center justify-center border-indigo-500">
    <div
      class="rounded-md overflow-hidden relative text-center p-4 group items-center flex flex-col max-w-sm hover:shadow-2xl transition-all duration-500 shadow-xl"
    >
      <UIcon
